    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
          <div>
            <h2 className="text-base font-semibold text-slate-900">Export Data Departemen</h2>
            <p className="text-xs text-slate-400 mt-0.5">{data.length} data departemen akan diexport</p>
          </div>
        ...
        <div className="flex items-center justify-end gap-2.5 px-5 py-4 border-t border-slate-100">
          ...
          >
            {exporting ? 'Mengexport...' : `Export ${data.length} Data Departemen`}
          </button>
        </div>
      </div>
    </div>
